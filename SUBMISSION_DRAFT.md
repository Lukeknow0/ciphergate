...
> **Submitted to DoraHacks on 2026-07-18.** This remains the source record for the submitted fields; re-check all claims against [`EVIDENCE.md`](EVIDENCE.md) before any later edit.
...
- Public source repository, passing CI/Pages deployment, `v1.0.0-hackathon` demo release, required [X post with demo video](https://x.com/mr_luhs/status/2078331526593577406), and [DoraHacks BUIDL 47145](https://dorahacks.io/buidl/47145) are available. The BUIDL is `Under Review`; the organizer currently lists submissions privately.
...
- CipherGate is deployed and Sourcify-verified on Sepolia. The source is public, Pages is live, the tagged demo release is published, the required [X post with demo video](https://x.com/mr_luhs/status/2078331526593577406) is live, and [DoraHacks BUIDL 47145](https://dorahacks.io/buidl/47145) is submitted and `Under Review`.
...
- [x] With explicit approval immediately before the final action, submit DoraHacks BUIDL 47145; current status `Under Review`.
...
- DoraHacks BUIDL: [47145](https://dorahacks.io/buidl/47145) (`Under Review`; organizer-private list)
