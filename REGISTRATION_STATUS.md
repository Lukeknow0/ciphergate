...
The next event action is the project submission, which is distinct from hacker registration. CipherGate still requires technical closure and explicit approval before any public repository/video/social publication or final DoraHacks project submission.
